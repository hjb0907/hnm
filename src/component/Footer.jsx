...
const Footer = () => {
  ...
  return (
    <div className='footer'>
        ...
        <ul className="row01">
          ...
          <ul>
            {list[0].row.map((category, idx) => (
              <li key={idx}><a href={list[0].link[idx]} >{category}</a></li>
            ))}
          </ul>
        </ul>
        <ul className="row02">
          <li>
            ...
            <ul>
              {list[1].row.map((category, idx) => (
                <li key={idx}><a href={list[1].link[idx]}  >{category}</a></li>
              ))}
            </ul>
          </li>
        </ul>
          ...
          <li>
            ...
            <ul>
              {list[2].row.map((category, idx) => (
                <li key={idx}><a href={list[2].link[idx]}>{category}</a></li>
              ))}
            </ul>
          </li>
        </ul>
      ...
      <div className="col03">
      <p>이 사이트의 콘텐츠는 저작권 보호를 받고 있는 H & M Hennes & Mauritz AB의 자산입니다. 더 보기 | 법인명 에이치앤엠헤네스 앤 모리츠 주식</p>
      <p>회사 | 통신판매업신고번호 : 2022-서울강남-01184 / 사업자등록| 번호: 220-87-83339 | 대표자: 아담 칼슨, 선 보라미, 아네타 포쿠친스카</p>
      <p>서울특별시 강남구 영동대로 421, 9층 삼탄빌딩 (대치동) 06182 | 대표번호 080-822-0220 info.kr@hm.com </p>
      <p>사업자 정보 확인 지급보증안내 법인명 에이치앤엠헤네스앤모리츠 주식회사 | 통신판매업신고번호 : 2022-서울강남-01184 / 사업자등록번호: 220-87-83339 | 아담 칼슨, 선 보라미, 아네타 포쿠친스카 | 서울특별시 강남구 영동대로 421, 9층 삼탄빌딩 (대치동) 06182 | 대표번호 080-822-0220 | info.kr@hm.com</p>
      <p>사업자 정보 확인</p>
      <p>지급보증안내</p>
      </div>
      <div className="col04">
